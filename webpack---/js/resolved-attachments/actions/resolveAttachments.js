...
import {
    resolveAttachmentsClient
} from '../clients/resolveAttachmentsClient';
import {
    RESOLVE_ATTACHMENTS
} from '../constants/resolvedAttachmentsActionTypes';
import {
    buildResolvedAttachmentsMapFromResponse
} from '../operators/buildResolvedAttachmentsMapFromResponse';
export const resolveAttachments = createDeprecatedAsyncAction({
