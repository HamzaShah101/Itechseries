...
const shouldRedirectForSuspension = response => !response.options.allowSuspended && response.data.user && Array.isArray(response.data.user.scopes) && response.data.user.scopes.indexOf('suspended') !== -1;
...
const hubUserInfoEndpointTest = (0, _index.createStack)(options => (0, _core.withUrl)(url => {
    ...
    return url;
})(options), (0, _core.method)('GET'), options => (0, _hubapi.lab)('HUBONEDOMAIN', (0, _hubapi.maybeAddApiPathPrefix)((0, _core.environmentUrl)((0, _core.hubletApi)('app', 'hubspot', options.hubletOverride))), (0, _core.environmentUrl)((0, _core.hubletApi)('api', 'hubspot', options.hubletOverride)))(options), options => (0, _core.query)({
    portalId: options.portalId
})(options));
