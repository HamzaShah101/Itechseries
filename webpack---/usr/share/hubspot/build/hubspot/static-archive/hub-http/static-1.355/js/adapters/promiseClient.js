...
exports.default = exports.setCreateClientForMocking = exports._originalClientImplCalled = void 0;
...
const maybeWithIframeXMLHttpRequest = options => {
    ...
    if (canUseAsyncIframeRequest) {
        return window.iframeXMLHttpRequestPromise.then(iframeXMLHttpRequest => (0, _update.set)('Request', iframeXMLHttpRequest)(optionsWithAdditionalHeaders)).catch(() => (0, _update.set)('Request', XMLHttpRequest)(options));
    }
...
let createClientImpl = optionMiddleware => {
...
const setCreateClientForMocking = fn => {
    createClientImpl = fn;
};

exports.setCreateClientForMocking = setCreateClientForMocking;

var _default = optionMiddleware => createClientImpl(optionMiddleware);
