...
} from './constants/LoadingSpinnerSizes';
import themePropType from '../utils/themePropType';
import {
    getLoadingSpinnerColor,
    getSecondaryLoadingSpinnerColor
} from './theme/loadingSpinnerOperators';
...
const VizExLoadingSpinner = props => {
    ...
    const resultDisplayTimeoutRef = useRef(null);
    useEffect(() => {
