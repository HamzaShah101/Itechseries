...
} from '../../context-update/operators/isContextUpdateMessage';
import ContextUpdateMessage from '../../context-update/records/ContextUpdateMessage';
import {
    isCrmObjectLifecycleUpdate
} from '../../crm-object-lifecycle-update/operators/isCrmObjectLifecycleUpdate';
...
import {
    isMessagesUpdateMessage
} from '../../message-updates/operators/isMessagesUpdateMessage';
...
import {
    isTypingMessage
} from '../../typing-indicator/operators/isTypingMessage';
import {
    isContactAssociationMessage
} from '../../contact-association-message/operators/isContactAssociationMessage';
import {
    isInboxUpdateMessage
} from '../../inbox-update-message/operators/isInboxUpdateMessage';
import {
    isReadThreadMessage
} from '../../read-thread-message/operators/isReadThreadMessage';
import {
    isThreadComment
} from '../../comment-message/operators/cmComparators';
import {
    isEmailCapturePromptMessage
} from '../../email-capture-prompt/operators/isEmailCapturePromptMessage';
import {
    isEmailCaptureResponseMessage
} from '../../email-capture-response/operators/isEmailCaptureResponseMessage';
import {
    isOfficeHoursMessage
} from '../../office-hours-message/operators/isOfficeHoursMessage';
import {
    isFilteredChangeMessage
} from '../../filtered-change-message/operators/isFilteredChangeMessage';
import {
    isThreadStatusUpdateMessage
} from '../../thread-status-update/operators/isThreadStatusUpdateMessage';
import OfficeHoursMessage from '../../office-hours-message/records/OfficeHoursMessage';
import {
    isTypicalResponseTimeMessage
} from '../../typical-response-time/operators/isTypicalResponseTimeMessage';
...
import {
    isAgentAvailabilityMessage
} from '../../agent-availability-message/operators/isAgentAvailabilityMessage';
...
} from '../../assignment-update-message/operators/isAssignmentUpdateMessage';
import AssignmentUpdateMessage from '../../assignment-update-message/records/AssignmentUpdateMessage';
import {
    isFeedbackSurveyMessage
} from '../../feedback-survey-message/operators/isFeedbackSurveyMessage';
import FeedbackSurveyMessage from '../../feedback-survey-message/records/FeedbackSurveyMessage';
import {
    isFeedbackSubmissionMessage
} from '../../feedback-submission/operators/isFeedbackSubmissionMessage';
import FeedbackSubmissionMessage from '../../feedback-submission/records/FeedbackSubmissionMessage';
import {
    isTranscriptSubmissionMessage
} from '../../transcript-submission/operators/isTranscriptSubmissionMessage';
import TranscriptSubmissionMessage from '../../transcript-submission/records/TranscriptSubmissionMessage';
import {
    isTicketCreationFailure
} from '../../ticket-creation-failure/operators/isTicketCreationFailure';
...
export function deserialize({
    ...
    if (isFeedbackSubmissionMessage(json)) {
        return new FeedbackSubmissionMessage(json);
    }
