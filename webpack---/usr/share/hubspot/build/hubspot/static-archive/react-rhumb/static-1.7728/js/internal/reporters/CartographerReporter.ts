...
const getMetricsEndpoint = memoize((endpoint, staticAppName, staticAppVersion) => {
...
export default class CartographerReporter extends BaseReporter {
  ...
  pushNavigationAction(routeInfo, previousRouteInfo, status, wasHidden, isHidden, duration) {
