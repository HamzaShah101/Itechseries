...
const buildRouteSpecs = (partialRouteSpecs, defaultTimeout) => {
...
const RhumbProvider = props => {
  ...
  const routeSpecs = useMemo(() => buildRouteSpecs(config, defaultTimeout || Constants.DEFAULT_TIMEOUT), [config, defaultTimeout]);
