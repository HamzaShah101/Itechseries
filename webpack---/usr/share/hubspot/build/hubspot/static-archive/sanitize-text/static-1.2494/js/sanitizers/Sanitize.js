...
import {
    secureDocument,
    config as SanitizeConfig
} from './SanitizeConfiguration';
import memoize from 'transmute/memoize';
import {
    removeStyles
} from 'sanitize-text/transformers/removeStyles';
import {
    standardizeBlockQuoteStyling
} from 'sanitize-text/transformers/standardizeBlockQuoteStyling';
import {
    removeInvalidAnchorProtocols
} from 'sanitize-text/transformers/removeInvalidAnchorProtocols';
import {
    buildSanitizer
} from './buildSanitizer';
import {
    addLinkTargetAttribute
} from '../transformers/addLinkTargetAttribute';
